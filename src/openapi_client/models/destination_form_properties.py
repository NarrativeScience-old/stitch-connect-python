...
class DestinationFormProperties(object):
    ...
    def __init__(self, csv_delimiter=None, output_file_format=None, s3_bucket=None, azure_storage_account_token=None, azure_storage_sas_url=None, database=None, local_vars_configuration=None):  # noqa: E501
