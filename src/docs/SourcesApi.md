...
create_source_body = openapi_client.CreateSourceBody() # CreateSourceBody | Request body to create a new source (optional)
...
# Create an instance of the API class
api_instance = openapi_client.SourcesApi()
...
api_instance = openapi_client.SourcesApi()
source_id = 'source_id_example' # str | The ID of the source
update_source_body = openapi_client.UpdateSourceBody() # UpdateSourceBody | Request body for updating a source (optional)
