...
class SourcesApi(object):
    ...
    def delete_source_with_http_info(self, source_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('source_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `source_id` when calling `delete_source`")  # noqa: E501
    ...
    def get_last_connection_check(self, source_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_last_connection_check_with_http_info(source_id, **kwargs)  # noqa: E501

    def get_last_connection_check_with_http_info(self, source_id, **kwargs):  # noqa: E501
        """Retrieves the last connection check for a source by the source’s unique identifier.   # noqa: E501
        ...
        if self.api_client.client_side_validation and ('source_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['source_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `source_id` when calling `get_last_connection_check`")  # noqa: E501
    ...
    def start_replication_with_http_info(self, source_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('source_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['source_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `source_id` when calling `start_replication`")  # noqa: E501
